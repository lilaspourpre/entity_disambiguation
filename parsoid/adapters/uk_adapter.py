...
class UkrainianAdapter(LanguageAdapter):
    def __init__(self):
        super().__init__()
        self.__article_types = {"./Категорія:Вибрані_статті": "featured", "./Категорія:Вікіпедія:Добрі_статті": "good"}

    def extract_categories(self, element_):
        return extract_categories(element_, "Вікіпедія")
    ...
    def is_be_category(self, element_):
        return element_.attrs["href"].startswith("./Категорія:")